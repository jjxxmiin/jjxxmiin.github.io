...
- [OpenAI 커스텀 GPT 공식 종료 발표, 플러그인 아키텍처 이전 마감 일정 정리]({% post_url 2026-09-19-openai-retires-custom-gpts-and-plans-migration-to-plugins-by-december-2026 %}) — OpenAI가 ChatGPT 커스텀 GPT를 단계적으로 종료하고 새로운 플러그인 아키텍처로 이전하는 계획을 공식 발표했습니다. Enterprise 워크스페이스는 2026년 9월 25일 신규 생성이 멈추고 2026년 12월 11일…
<!-- internal-links:end -->
