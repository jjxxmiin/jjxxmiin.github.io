...
faq:
  - question: 클로드 무료 요금제로 Claude Code를 쓸 수 있나요?
    answer: 쓸 수 없습니다. Claude Code는 Pro 이상 유료 구독 또는 Anthropic Console의 API 키가 있어야 사용할 수 있습니다. Free 등급에는 포함되지 않습니다.
  - question: Pro와 Max의 차이는 무엇인가요?
    answer: 기능 차이가 아니라 사용량 한도 차이입니다. Max 5x는 Pro의 5배, Max 20x는 20배 사용량을 제공합니다. 쓸 수 있는 모델과 기능은 같습니다.
  - question: 클로드 요금제를 중간에 바꾸거나 해지할 수 있나요?
    answer: 가능합니다. 구독 설정에서 언제든 변경과 해지가 되며, 해지해도 이미 결제한 기간이 끝날 때까지는 유료 기능을 계속 쓸 수 있습니다.
  - question: 구독료를 냈는데 API 요금이 또 나오나요?
    answer: 구독과 API는 별개 결제입니다. Claude 앱과 Claude Code를 구독으로 쓰면 추가 과금이 없지만, Anthropic Console에서 API 키를 발급해 직접 호출하면 그 사용량은 별도로 청구됩니다.
  - question: 연간 결제하면 얼마나 싼가요?
    answer: Pro 기준 월 결제 20달러가 연간 결제 시 월 17달러가 되어 약 15% 저렴합니다. 1년에 36달러 차이입니다.
---

**클로드 유료 구독은 Pro 월 20달러부터 시작합니다.** Claude Code를 쓰려면 이 Pro 이상이 필요하고, 무료 등급으로는 쓸 수 없습니다.

요금제 이름이 Free, Pro, Max 5x, Max 20x, Team, Enterprise로 여섯 가지나 되는데다 같은 Max 안에서도 등급이 갈려서, 처음 보면 뭘 골라야 할지 판단이 안 섭니다. 2026년 8월 23일 기준으로 정리합니다.
...
Team은 좌석당 과금이고 두 종류가 있습니다. Standard는 연간 결제 기준 좌석당 월 20달러, Premium은 월 100달러입니다. Premium이 비싼 이유는 Claude Code 사용량이 더 넉넉하기 때문입니다.
...
여기에 하나 덧붙이면, 회사 비용으로 처리할 계획이라면 **Team Standard 좌석이 개인 Pro보다 5달러 비싼 대신 중앙 청구가 된다**는 점이 실무에서는 꽤 큰 차이입니다. 개인 카드로 결제하고 매달 영수증 처리하는 수고가 사라집니다.
