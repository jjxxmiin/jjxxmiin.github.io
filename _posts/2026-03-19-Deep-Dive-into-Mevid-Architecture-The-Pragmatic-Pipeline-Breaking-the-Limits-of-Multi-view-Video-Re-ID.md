...
- [센서값이 계속 흔들릴 때 칼만 필터는 무엇을 믿을까: 예측과 측정의 균형]({% post_url 2019-04-21-kalman %}) — 칼만 필터가 이전 상태의 예측과 새 센서 측정을 오차 공분산에 따라 결합하는 원리를 누적 평균에서 출발해 설명합니다. Time Update와 Measurement Update의 역할, Q·R·P·K를 조정할 때의 의미와 선형·비선형…
