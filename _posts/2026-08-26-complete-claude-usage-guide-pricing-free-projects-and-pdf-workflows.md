...
title: '클로드(Claude) 사용법: 무료·Pro 요금제, 프로젝트·PDF·Skills 가이드'
...
- 튜토리얼
- MCP
description: Claude 무료·Pro 요금제와 프로젝트 5개 제한, 채팅·프로젝트 파일 용량, PDF 시각 분석, Artifacts·Skills·공유 보안을 공식 문서 기준으로 비교합니다.
summary: 2026년 8월 26일 기준 Claude 무료·Pro 플랜, 프로젝트와 RAG, 채팅·프로젝트 파일 제한, PDF·Artifacts·Skills·공유 기능을 공식 문서로 비교합니다.
target_keyword: 클로드 사용법
keyword_tier: T1
sitemap: true
image:
  path: /assets/img/thumb/complete-claude-usage-guide-pricing-free-projects-and-pdf-workflows.jpg
  alt: '클로드 사용법과 요금제·무료 프로젝트·PDF 활용을 안내하는 OPSOAI 대표 이미지'
faq:
