...
- [딥러닝 면접에서 자주 막히는 확률 질문 7개: Logit·Entropy·Binomial까지]({% post_url 2022-01-12-interview %}) — 공식을 외웠는데 설명이 막히는 딥러닝 면접 대비자를 위해 odds와 logit, sigmoid 미분, NLL, 조건부확률, entropy, Bernoulli·Binomial의 연결을 답변형으로 정리합니다.
<!-- internal-links:end -->
