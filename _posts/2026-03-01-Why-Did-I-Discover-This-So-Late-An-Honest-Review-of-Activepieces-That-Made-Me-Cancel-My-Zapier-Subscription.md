...
- [trycua/cua VM이면 AI에 Mac을 맡겨도 안전할까: Lume, CUI, Network 경계]({% post_url 2026-04-27-I-Handed-Over-My-MacBook-to-AI-Why-trycuacua-is-the-End-of-Traditional-Browser-Automation %}) — trycua/cua가 Lume VM과 CUI로 데스크톱을 격리하는 구조를 살펴보고, 일회용 환경이어도 네트워크, 비밀, 호스트 공유와 토큰 비용은 별도로 통제해야 하는 이유를 설명합니다.
<!-- internal-links:end -->
