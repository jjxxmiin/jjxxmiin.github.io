...
- [OpenAI의 GPT-6 Sol과 GPT-6 Luna 출시, 요금은 반값으로 내리고 작업 오류는 줄였다]({% post_url 2026-09-24-openai-launches-gpt-6-sol-and-gpt-6-luna-halving-pricing-across-bedrock-and-api %}) — OpenAI가 2026년 9월 22일 새 인공지능 모델 GPT-6 Sol과 GPT-6 Luna를 정식 출시했습니다. GPT-6 Sol은 백만 토큰당 입력 2달러와 출력 10달러로 요금을 50퍼센트 낮췄고, GPT-6 Luna는 입력…
<!-- internal-links:end -->
